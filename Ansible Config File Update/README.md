...
-rw-r--r-- 1 thor thor  237 Oct 16 17:01 hosts
drwxr-xr-x 2 thor thor 4096 Oct 16 17:01 roles
```
...
```html
#remote_user=root   -> remote_user=mark
```
...
```bash
CONGRATULATIONS!!!!
You have successfully completed the quiz. Results have been saved. Ref ID:63551f6e931752606c89e179
```
